...
| `RelayConnectionTarget`   | Managed Coda Connect relay tunnels.                                        |
...
Managed Coda Connect relay tunnels use `RelayConnectionTarget` and are the answer when the host is
