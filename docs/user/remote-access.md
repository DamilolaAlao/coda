...
### Deregister a Coda Connect Environment

Open your account menu and choose **Coda Connect** to see every environment registered to your
account. On mobile, open **Settings** → **Coda Connect**. Choose **Deregister** to revoke an
environment's Coda Connect access, remove any managed tunnel, and free its host space.
