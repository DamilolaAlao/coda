...
- Reads the shared production Coda Connect relay URL and Clerk client configuration before packaging clients.
...
10. Complete the Clerk Native API and AASA setup in [Coda Connect Clerk Setup](../internals/t3-connect.md#desktop-passkeys).
