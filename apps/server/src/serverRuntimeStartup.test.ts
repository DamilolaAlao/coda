...
import { HERMES_DEFAULT_MODEL, ProjectId, ProviderInstanceId, ThreadId } from "@t3tools/contracts";
...
it("uses Hermes on OpenCode Go for auto-bootstrapped model selection", () => {
