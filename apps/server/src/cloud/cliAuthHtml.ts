...
<html lang="en">
  <head>
    ...
    <title>Coda Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up Coda Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
