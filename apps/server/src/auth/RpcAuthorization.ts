...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.sourceControlStartGitHubOAuth]: AuthOrchestrationOperateScope,
  [WS_METHODS.sourceControlDisconnectGitHub]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.backgroundAppsList]: AuthOrchestrationReadScope,
  [WS_METHODS.backgroundAppsStart]: AuthTerminalOperateScope,
  [WS_METHODS.backgroundAppsStop]: AuthTerminalOperateScope,
  [WS_METHODS.backgroundAppsRestart]: AuthTerminalOperateScope,
  [WS_METHODS.backgroundAppsLogs]: AuthOrchestrationReadScope,
  [WS_METHODS.subscribeBackgroundApps]: AuthOrchestrationReadScope,
