    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Coda agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Coda to connect to Coda servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Coda to access your camera so you can scan pairing QR codes.",
