...
export const HermesIcon: Icon = ({ className, ...props }) => (
  <svg
    ...
    viewBox="0 0 24 24"
    fill="none"
    className={cn("fill-[#C4A35A] dark:fill-[#E8D5A3]", className)}
  >
    <path d="M12 3.2 8.2 6.4H4.6L8.8 2.6h6.4L19.4 6.4h-3.6L12 3.2Z" />
    <path d="M11.15 6.2h1.7v14.6h-1.7z" />
    <path d="M7.1 9.1c1.6-1.5 3.4-1.9 4.9-1.1 1.9 1 2.1 3.4.4 5.1-1.4 1.4-2.8 1.8-4.2 1.1l.7-1.5c.7.3 1.5.1 2.3-.7.8-.8.7-1.7-.1-2.1-.8-.4-1.9.1-3 1.2L7.1 9.1Zm9.8 5.7c-1.6 1.5-3.4 1.9-4.9 1.1-1.9-1-2.1-3.4-.4-5.1 1.4-1.4 2.8-1.8 4.2-1.1l-.7 1.5c-.7-.3-1.5-.1-2.3.7-.8.8-.7 1.7.1 2.1.8.4 1.9-.1 3-1.2l1 1.2Z" />
    <circle cx="12" cy="21.1" r="1.15" />
  </svg>
);
