...
const T3_CHAT_LIGHT_COLORS: ThemeColors = {
  canvas: "#fdf7fd",
  // Coda's workspace header belongs to the chat panel, so keep it seamless
  ...
  // dark plum pair here also leaked the dark palette into Coda's diffs.
...
const T3_CHAT_DARK_COLORS: ThemeColors = {
  ...
  // Diffs and file previews are full workspace surfaces in Coda. Keep them
...
/**
 * The palette Coda wears with no theme installed, captured from the app's
...
/**
 * The standard Coda look as a theme palette, for seeding a new theme when
...
/**
 * The status colors Coda shows without a theme, read from the app's own
